...
class BillingSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'fx_usd_cop_rate': 'TRM (COP por 1 USD)',
            'show_dual_currency': 'Mostrar doble moneda',
            'rounding_policy': 'Política de redondeo',
        ...
        widgets = {
            ...
            'fx_usd_cop_rate': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.000001', 'min': '0'}),
            'show_dual_currency': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'rounding_policy': forms.Select(attrs={'class': 'form-select'}),
