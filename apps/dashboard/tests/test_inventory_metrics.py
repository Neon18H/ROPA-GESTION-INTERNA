...
class InventoryMetricsTests(TestCase):
    def test_uses_product_stock_and_product_suggested_price(self):
        ...
        ProductStock.objects.create(organization=org, product=product_a, qty=10)
        ProductStock.objects.create(organization=org, product=product_b, qty=14)
        ...
        self.assertEqual(metrics['inventory_value'], Decimal('1700.00'))
